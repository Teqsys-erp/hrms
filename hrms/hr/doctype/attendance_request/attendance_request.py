...
# path - hrms/hrms/hr/doctype/attendance_request
...
class AttendanceRequest(Document):
        ...
        def create_or_update_attendance(self, date: str):
                ...
                status = self.custom_final_day_status  # Using final status from Attendance Request
                ...
                if doc:
                        ...
                        updates = {
                                ...
                                "working_hours": self.custom_working_hours,
                        ...
                        doc.status = status
                        doc.working_hours = self.custom_working_hours
                        doc.in_time = self.custom_in_time
                        doc.out_time = self.custom_out_time
